  ...
  var handleForm = function() {
    ...
    $("#details-form").submit(function(event) {
      ...
      if (canSubmitForm) {
        ...
        Email.send({
          SecureToken: "36ae926d-4020-4f0a-bd8b-32a3c6625406",
          To: "safesoundmonitor@gmail.com",
          From: "safesoundmonitor@gmail.com",
          Subject: "new form submition sound monitor",
          Body: queryString
        }).then(message => window.location.replace("/checkout.html"));
      }
    });

    $("#form-submit-catch").click(function(event) {
      console.log("click");
      $("#form-error div").show();
      $("#form-error").css("margin-bottom", "20px");
    });

    // $(".form-control").keypress(checkFormFields);
    $(".form-control").change(checkFormFields);
    ...
    function checkFormFields() {
      ...
      if (isNameValid && isEmailValid) {
        ...
        $("#form-submit-catch").hide();
        $("#form-error div").hide();
        $("#form-error").css("margin-bottom", "0px");
        canSubmitForm = true;
      } else {
        $("#form-submit").prop("disabled", true);
        $("#form-submit-catch").show();
        $("#form-error div").show();
        $("#form-error").css("margin-bottom", "20px");
      }
